 ...
 * Direct links for [D2Coding.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/D2Coding.zip) or [D2Coding.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/D2Coding.tar.xz)
