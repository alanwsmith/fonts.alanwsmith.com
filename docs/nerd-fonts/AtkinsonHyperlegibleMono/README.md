...
## Why `AtkynsonMono` and not `Atkinson Hyperlegible Mono`?
 ...
 * Direct links for [AtkinsonHyperlegibleMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AtkinsonHyperlegibleMono.zip) or [AtkinsonHyperlegibleMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AtkinsonHyperlegibleMono.tar.xz)
