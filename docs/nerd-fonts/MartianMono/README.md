 ...
 * Direct links for [MartianMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/MartianMono.zip) or [MartianMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/MartianMono.tar.xz)
