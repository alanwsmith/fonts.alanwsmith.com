 ...
 * Direct links for [UbuntuSans.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/UbuntuSans.zip) or [UbuntuSans.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/UbuntuSans.tar.xz)
