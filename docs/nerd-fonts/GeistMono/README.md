 ...
 * Direct links for [GeistMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/GeistMono.zip) or [GeistMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/GeistMono.tar.xz)
