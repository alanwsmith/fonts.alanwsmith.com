 ...
 * Direct links for [CommitMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/CommitMono.zip) or [CommitMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/CommitMono.tar.xz)
